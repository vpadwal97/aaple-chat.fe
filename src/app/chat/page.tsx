...
export default function ChatPage() {
  ...
  const addInterest = () => {
    ...
    // update URL
    router.push(`/chat?interests=${updated.join(",")}`);
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white flex items-center justify-center md-max:px-4 px-2">
      <div className="w-full max-w-xl bg-slate-900 border border-slate-800 rounded-3xl p-8 shadow-2xl">
        ...
        {/* INTERESTS */}
        <div className="mb-6">
          <label className="block mb-2 text-sm text-slate-400">Interests</label>
          ...
          <div className="flex gap-2">
            ...
            <button
              onClick={addInterest}
              className="bg-blue-600 hover:bg-blue-700 px-5 py-2 rounded-2xl "
            >
              Add
            </button>
          </div>
